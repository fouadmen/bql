...
import storeSlice, { retrieveStore } from "./store_reducer";
...
export {setcartItems, setProductInfo, setProductImage, resetProductState, setProfileInfo, logIn, signOut, signUp, retreiveToken, retrieveStore}
